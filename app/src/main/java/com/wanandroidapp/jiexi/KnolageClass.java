 ...
 public DataBean(String name){
     this.name=name;
        ...
        public static class ChildrenBean {
             ...
             * visible : 1
             */
            public ChildrenBean(String sonname){
                this.name=sonname;

            }
            public ChildrenBean(String sonname,int id){
                this.name=sonname;
                this.id=id;
            }
            private int courseId;
            private int id;
            private String name;//子标题
            private int order;
            private int parentChapterId;
            private boolean userControlSetTop;
            private int visible;
